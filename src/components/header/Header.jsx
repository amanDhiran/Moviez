...
function Header() {
  ...
  return (
    <header
      className={`fixed w-full h-[60px] z-[2] flex items-center ${
        show === "show"
          ? "bg-black3"
          : show === "hide"
          ? "translate-y-[-60px]"
    ...
    >
      <ContentWrapper className="flex items-center justify-between">
        ...
        <ul
          className={` md:flex ${
            mobileMenu
              ? "flex absolute top-[60px] left-0 bg-black3 flex-col w-full py-5 border-t-slate-700 border-t z-[1] animate-mobileMenu"
              : "list-none hidden items-center"
          }`}
        >
          <li
      ...
      {showSearch && (
        <div className=" animate-mobileMenu w-full h-[60px] bg-white absolute top-[60px] ">
          <ContentWrapper>
